document.addEventListener('DOMContentLoaded', function() {
    ...
    var flushCollapseTwo = document.getElementById('flush-collapseTwo');
    ...
    accordionButtonOne.addEventListener('click', function() {
      toggleAccordion(accordionButtonOne, flushCollapseOne);
    });
    accordionButtonTwo.addEventListener('click', function() {
      toggleAccordion(accordionButtonTwo, flushCollapseTwo);
    });
  });